...
Wrapper.prototype.computed = function computed () {
  ...
  warn$1('functions returned by computed() will not have this bound to the vue instance. Calling a computed function that uses this will result in an error. You can access computed functions by using the vue instance. e.g. to call a computed function named compFunc, call wrapper.vm.compFunc. See https://github.com/eddyerburgh/avoriaz/issues/15');
...
Wrapper.prototype.hasStyle = function hasStyle (style, value) {
  ...
  if (navigator.userAgent.includes && navigator.userAgent.includes('node.js')) {
    warn$1('wrapper.hasStyle is not fully supported when running jsdom - only inline styles are supported');
  }
...
Wrapper.prototype.methods = function methods () {
  ...
  warn$1('functions returned by methods() will not have this bound to the vue instance. Calling a method that uses this will result in an error. You can access methods by using the vue instance. e.g. to call a method function named aMethod, call wrapper.vm.aMethod(). See https://github.com/eddyerburgh/avoriaz/issues/15');
...
Wrapper.prototype.propsData = function propsData () {
  ...
  warn$1('functions returned by propsData() will not have this bound to the vue instance. Calling a propsData function that uses this will result in an error. You can access propsData functions by using the vue instance. e.g. to call a method function named propsDataFunc, call wrapper.vm.$props.propsDataFunc(). See https://github.com/eddyerburgh/avoriaz/issues/15');
...
var vueAddGlobals = function (Vue, globals) {
...
function createInstance(component, options) {
  var instance = options.instance || Vue$3;
...
function replaceComponents(component) {
  Object.keys(component.components).forEach(function (c) {
    ...
    component.components[c] = Object.assign({}, extractCoreProps(component.components[c]),
      {render: function () {}});
    Vue$3.config.ignoredElements.push(c);
    stubLifeCycleEvents(component.components[c]);
  });
}
...
function shallow(component, options) {
  ...
  replaceGlobalComponents(Vue$3, clonedComponent);

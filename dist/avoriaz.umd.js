(function (global, factory) {
	...
	(global.avoriaz = factory(global.Vue));
...
var vueAddGlobals = function (Vue$$1, globals) {
...
function createInstance(component, options) {
  ...
  if (options.globals) {
    vueAddGlobals(Constructor, options.globals);
  }
...
/* istanbul ignore next */
if (commonjsGlobal.Element && !commonjsGlobal.Element.prototype.matches) {
  commonjsGlobal.Element.prototype.matches =
    commonjsGlobal.Element.prototype.matchesSelector ||
    commonjsGlobal.Element.prototype.mozMatchesSelector ||
    commonjsGlobal.Element.prototype.msMatchesSelector ||
    commonjsGlobal.Element.prototype.oMatchesSelector ||
    commonjsGlobal.Element.prototype.webkitMatchesSelector ||
